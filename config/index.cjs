...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx60cf4339185b7639',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '834ee4f5a208eeba77de5c55aa2ab0c0',
  ...
  USERS: [
    {
      ...
      id: 'ox7dv6VIf5unXm1Q22MKjExGnwkI',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'EfdRkahKq0JHjjdq2z93nfv5KwOVxxT9KoY8tuqsEg0',
      // 所在省份
      province: '辽宁',
      // 所在城市
      city: '大连',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '傻狍子', year: '2002', date: '09-01',
        },
        {
